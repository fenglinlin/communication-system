    ...
    <td height="30" colspan="2" align="center" valign="bottom"><table width="100%" border="0" cellspacing="1" cellpadding="1">
        <tr>
          ...
          <td width="85%" valign="bottom"><div class='icoitem'>
              ...
              <div class='txt'><a href='showDetail.jsp'><u>添加用户</u></a></div>
            </div>
            <div class='icoitem'>
              <div class='ico'><img src='skin/images/frame/menuarrow.gif' width='16' height='16' /></div>
              <div class='txt'><a href='userAction!listOnline'><u>查看在线用户</u></a></div>
            </div>
            <!--<div class='icoitem'>
...
<table width="98%" align="center" border="0" cellpadding="4" cellspacing="1" bgcolor="#CBD8AC">
  <tr bgcolor="#EEF4EA">
    <td colspan="2" background="skin/images/frame/wbg.gif" class='title'><span>服务器</span>操作<br></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td height="32">开启服务器：<br></td>
    <td> <input type="button" name="start" onclick="getStartInfo()" value="开启服务"></td>
  </tr>
  <tr bgcolor="#FFFFFF">
    <td width="25%" height="32">关闭服务器：</td>
    <td width="75%"> <input type="button" name="close" onclick="getCloseInfo()" value="关闭服务"> </td>
  </tr>
</table>
 </form>
<br>
